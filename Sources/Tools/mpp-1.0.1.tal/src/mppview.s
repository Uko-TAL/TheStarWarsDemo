...
plug_nbitplane			equ	10
plug_timera_data		equ	12
plug_flags			equ	14
plug_pal_adr			equ	16
plug_init			equ	20
plug_palette_unpack		equ	24
plug_timera			equ	28
...
mpnm:	move.b	#$a0,d0	; aligned picture address
	...
	lsr	#1,d3		; copy per word

	move	plug_height(a6),d1
	subq	#2,d1
	
	cmp	#3,plug_nbitplane(a6)	; 3 or 4 bitplanes ?
	bne.s	rdi4bp
...
plugins:
	dc.w	mode0-plugins, mode1-plugins, mode2-plugins, mode3-plugins, mode4-plugins, mode5-plugins

mode0:	include	"mode0.s"
mode1:	include	"mode1.s"
mode2:	include	"mode2.s"
mode3:	include	"mode3.s"
mode4:	include	"mode4.s"
mode5:	include	"mode5.s"
	bss
z:
mch:	ds.w	1
vecptr:	ds.l	1
