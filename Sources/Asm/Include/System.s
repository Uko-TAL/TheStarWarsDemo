...
; \1 = adress register containing the pointer to the address to be set
setScreenAddrPtr	macro
	move.b 1(\1),(HW_SHIFTER_ADR+$1).w
	move.b 2(\1),(HW_SHIFTER_ADR+$3).w
	move.b 3(\1),(HW_SHIFTER_ADR+$D).w
	endm
